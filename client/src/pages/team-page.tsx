      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            <h2 className="text-3xl font-bold mb-4">Enterprise Feature</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-8">
              Team collaboration is available for Enterprise users. Upgrade to unlock team features, shared workspaces, and collaborative resume creation.
            </p>
